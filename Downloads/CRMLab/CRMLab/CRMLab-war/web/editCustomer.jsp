...
<html>
  ...
  <body>
    ...
    <c:forEach var="field" items="${customer.fields}">
      <span style="text-transform: capitalize">${field.name}</span>: ${field.fieldValue}
       <a href="doDeleteField?cId=${customer.id}&fId=${field.id}" style="font-size: small"> (delete field)</a> <br />
    </c:forEach>
  </body>
</html>